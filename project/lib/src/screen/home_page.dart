...
// /// add category ibtisam new admin ************************************
  ...
  Category newCategory = Category(
      name: AddCategoryPage.iiname,
      imagePath: AddCategoryPage.imageeload); // Replace with actual image path
            ...
            children: [
              ...
              ClipOval(
                ...
                child: _buildImage(category
                    .imagePath), // Use a helper function to determine asset or file
