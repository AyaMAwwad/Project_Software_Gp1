      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            buildStatisticCard(
                'Percentage Sold',
                '${percetagesold.toStringAsFixed(2)}%',
                Icons.pie_chart,
                Colors.orange),
            buildStatisticCard(
                'Total Revenue',
                ...
                Colors.purple),
            buildStatisticCard(
                'Total Admin Profit Percentage',
                '${sumProfitPercentage.toStringAsFixed(2)}%',
                Icons.percent,
                Colors.red),
            buildStatisticCard(
                'Total Admin Profit',
                '\$${sumProfit.toStringAsFixed(2)}',
            ...
            Center(
              child: ElevatedButton(
                ...
                child: Text(showChart ? 'Hide Chart' : 'Show Chart',
              ...
              Column(
                children: [
                  ...
                  buildLegendItem(Color.fromARGB(255, 43, 120, 143),
                      'Percentage Sold'), // Color.fromARGB(255, 43, 120, 143),
                  buildLegendItem(Color.fromARGB(255, 8, 113, 103),
                      'Admin Profit Percentage'),
                  buildLegendItem(const Color.fromARGB(255, 199, 198, 198),
